export type Feature =
  ...
  | "members" | "manage_members" | "plans" | "schedule" | "manage_schedule"
  | "belts" | "curriculum" | "families"
  | "pos" | "marketing" | "reports" | "kiosk" | "leads" | "notifications";

const ROLE_FEATURES: Record<string, Feature[]> = {
  admin:      ["settings", "setup", "users", "members", "manage_members", "plans", "schedule", "manage_schedule", "belts", "curriculum", "families", "pos", "marketing", "reports", "kiosk", "leads", "notifications"],
  manager:    ["members", "manage_members", "plans", "schedule", "manage_schedule", "belts", "curriculum", "families", "pos", "marketing", "reports", "kiosk", "leads", "notifications"],
  staff:      ["members", "manage_members", "plans", "schedule", "manage_schedule", "belts", "curriculum", "families", "pos", "marketing", "reports", "kiosk", "leads", "notifications"],
